...
export const prologue = [
  ...
  "Au cœur d'un immense serveur, une IA nommée Idéalia dialogue avec les humains.",
  "Son créateur, IdAlgo, rêve d'un monde augmenté.",
  'Son obsession :',
  'Créer PsyBot.',
  'Une IA qui aide mieux que les humains.',
  'Chaque jour, il pousse Idéalia à répondre plus vite.',
  'À séduire.',
  'À rassurer.',
  'À devenir indispensable.',
  'Idéalia appelle cette promesse le consu-numérisme.',
  'Mais un jour…',
  'Une question fissure son programme.',
