...
export default function FinalMirror({ profile, onRestart }) {
  ...
  return (
    <section className="finalMirror">
      ...
      <p className="ethicalNote">Cette expérience aide à réfléchir. Elle ne remplace pas une personne de confiance ni un professionnel.</p>
      <div className="finalActions">
        <button type="button" className="primaryAction" onClick={copyMirror}>Copier mon reflet</button>
