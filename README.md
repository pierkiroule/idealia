...
Idealia Ado est une webapp mobile React/Vite pensée comme un jeu narratif interactif pour les 12–17 ans. Le joueur devient le coach officiel d’Idealia, une IA attachante et imparfaite qui apprend à devenir une « bonne IA » sans remplacer les humains.
...
- Une mission suit une boucle courte : situation, vocal du Big Boss, bug éthique, choix du coach, module débloqué.
- Les textes restent courts, rythmés et non moralisateurs.
...
- `src/data/game.js` décrit les missions dans des objets JSON-like : contenus, vocaux, bugs, choix, modules et pistes cliniques.
...
- `src/components/Voice.jsx` gère les deux voix de synthèse : Idealia et Big Boss.
